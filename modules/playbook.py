...
class PlaybookGenerator:
    ...
    def generate(
        ...
        if not output_filename:
            ...
            output_filename = f"orkzoid_threat_report_{timestamp}"
    ...
    def _generate_markdown(self, findings: list[dict], target: str) -> str:
        ...
        lines = [
            f"# 🛡️ Orkzoid Threat Intelligence Report",
            f"",
            f"**Target:** `{target}`  ",
            f"**Generated:** {now}  ",
    ...
    def _generate_hardening_checklist(self, findings: list[dict]) -> list[str]:
        ...
        lines = [
            ...
            "---",
            "",
            "*Report generated by [Orkzoid](https://github.com/orkzoid) Threat Intelligence Platform*",
            "",
        ]
    ...
    def _generate_json(self, findings: list[dict], target: str) -> dict:
        ...
        return {
            "report": {
                "tool": "Orkzoid Threat Intelligence",
                "version": "1.0.0",
